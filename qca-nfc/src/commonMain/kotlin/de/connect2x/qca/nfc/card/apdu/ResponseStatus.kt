...
internal typealias ExpectedResponseStatus = Map<Int, ResponseStatus>

internal val generalAuthenticateStatus: ExpectedResponseStatus = mapOf(
...
internal val pinStatus: ExpectedResponseStatus = mapOf(
    0x9000 to ResponseStatus.SUCCESS,
...
internal val manageSecurityEnvironmentStatus: ExpectedResponseStatus = mapOf(
    0x9000 to ResponseStatus.SUCCESS,
    0x6A81 to ResponseStatus.UNSUPPORTED_FUNCTION,
    0x6A88 to ResponseStatus.KEY_NOT_FOUND,
)

internal val psoComputeDigitalSignatureStatus: ExpectedResponseStatus = mapOf(
    0x9000 to ResponseStatus.SUCCESS,
...
internal val readStatus: ExpectedResponseStatus = mapOf(
    0x9000 to ResponseStatus.SUCCESS,
...
internal val readStructuredEfStatus: ExpectedResponseStatus = readStatus + mapOf(
    0x6296 to ResponseStatus.RECORD_DEACTIVATED,
    0x6A83 to ResponseStatus.RECORD_NOT_FOUND,
)

internal val selectStatus: ExpectedResponseStatus = mapOf(
    0x9000 to ResponseStatus.SUCCESS,
...
internal val verifySecretStatus: ExpectedResponseStatus = mapOf(
    0x9000 to ResponseStatus.SUCCESS,
...
internal val resetRetryCounterStatus: ExpectedResponseStatus = mapOf(
    0x9000 to ResponseStatus.SUCCESS,
...
internal val changeReferenceDataStatus: ExpectedResponseStatus = mapOf(
    0x9000 to ResponseStatus.SUCCESS,
    0x63C0 to ResponseStatus.WRONG_SECRET_WARNING_COUNT_00,
    0x63C1 to ResponseStatus.WRONG_SECRET_WARNING_COUNT_01,
    0x63C2 to ResponseStatus.WRONG_SECRET_WARNING_COUNT_02,
